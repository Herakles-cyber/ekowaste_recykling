...
document.addEventListener('DOMContentLoaded', function () {
    // Poczekaj chwilę, aż strona zostanie załadowana, a następnie dodaj klasę do rozpoczęcia animacji
    setTimeout(function () {
        document.getElementById('slideInParagraph').classList.add('slide-in');
    }, 100);
});